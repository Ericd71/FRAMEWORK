...
void Entity::Render(Image* framebuffer, Camera* camera, const Color& c, int menu) {
    //Get vertices
...
//            
//            //framebuffer->DrawTriangle(Vector2(vertices[0].x, vertices[0].y, vertices[0].z), Vector2(vertices[1].x, vertices[1].y), Vector2(vertices[2].x, vertices[2].y), Color::CYAN, 1, Color::CYAN);
//        }
    }
}
